...
router.register(r'chains', ChainViewSet, 'chains')
...
router.register(r'monitorflows', MonitorViewSet, 'monitorflows')
router.register(r'impactflows', ImpactViewSet, 'impactflows')
